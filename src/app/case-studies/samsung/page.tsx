...
export async function generateMetadata() {
  return Meta.generate({
    title: "Samsung Mobile App – Case Study",
    description: "Deep-dive into the Samsung mobile app redesign.",
    baseURL: baseURL,
    image: `/api/og/generate?title=${encodeURIComponent("Samsung Case Study")}`,
    path: "/case-studies/samsung",
  });
}

function getSamsungImages(): string[] {
  const dir = path.join(process.cwd(), "public", "images", "samsung-casestudy");
  ...
  return files.map((f) => `/images/samsung-casestudy/${f}`);
}

export default function SamsungCaseStudy() {
  const images = getSamsungImages();
  return (
    <Column fillWidth gap="l" paddingY="xl">
      <Schema
        ...
        author={{
          name: person.name,
          url: `${baseURL}/case-studies/samsung`,
